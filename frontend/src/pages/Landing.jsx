    ...
    <div className="min-h-screen bg-black text-white selection:bg-primary-500 selection:text-black relative overflow-hidden">
      ...
      <div className="relative min-h-screen flex items-center justify-center">
        ...
        <div className="relative z-10 container mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl mb-12 text-gray-400 max-w-3xl mx-auto leading-relaxed animate-fade-in-up delay-100">
            Experience premium rides with top-rated drivers, real-time tracking, and seamless payments. Your destination awaits.
          </p>
